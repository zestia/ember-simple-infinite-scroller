window.EmberENV={FEATURES:{},EXTEND_PROTOTYPES:!1,_JQUERY_INTEGRATION:!1}
...
o>0&&(i.writeWatching(t,o-1),1===o&&i.writableChains(fe).remove(t))}}function we(e,t,n){M(t)?be(e,t,n):j(e,t,n)}function Ee(e,t){var n=(0,r.peekMeta)(e)
return null!==n&&n.peekWatching(t)||0}function Oe(e,t,n){M(t)?_e(e,t,n):L(e,t,n)}e.ChainNode=ye
...
n&&(n.isSourceDestroying()||n.isMetaDestroyed())?Re.delete(t):e.forEach((function(e,n){if(!e.suspended&&!(0,s.validate)(e.tag,e.lastRevision))try{e.suspended=!0,O(t,n,[t,e.path])}finally{e.suspended=!1,e.tag=(0,s.combine)(Je(t,e.path)),e.lastRevision=(0,s.value)(e.tag)}}))}))}function Le(e,t,n){var r=Re.get(e)
...
null!==i&&(i.isInitializing()||i.isPrototypeMeta(e))||(null!==i&&V(e,t,i),De<=0&&je(),Ie in e&&e[Ie](t))}function Be(){De++}function Ue(){--De<=0&&je()}function ze(e){Be()
...
function Nt(e,t){return t instanceof qt?e.hasMixin(t)?Mt:(e.addMixin(t),t.properties):t}function jt(e,t,n,r){var i=n[e]||r[e]
...
Pt(c)?(u=!0,s[l]=Lt(e,l,c,a,{})):s[l]=c}return u&&(s._super=i.ROOT),s}(e,t,r,s):Pt(r)&&(r=Lt(e,t,r,s,a)),a[t]=void 0,s[t]=r)}function Dt(e,t,n,r){var o=(0,i.getObservers)(n),a=(0,i.getListeners)(n)
...
function f(e){delete r[e],delete i[e]}for(var p=0;p<t.length;p++)if((u=Nt(n,s=t[p]))!==Mt)if(u){for(l in o.willMergeMixin&&o.willMergeMixin(u),c=jt("concatenatedProperties",u,i,o),h=jt("mergedProperties",u,i,o),u)u.hasOwnProperty(l)&&(a.push(l),It(o,l,u[l],n,r,i,c,h))
...
e=o[0],t=o[1],void 0===(r=o[2])?i=0:u(i=r.pop())||(n=!0===i,i=r.pop())}return[e,t,r,i=parseInt(i,10),n]}var E=0,O=0,T=0,R=0,k=0,A=0,C=0,P=0,S=0,x=0,M=0,N=0,j=0,L=0,I=0,D=0,F=0,B=0,U=0,z=0,V=0,q=function(){function e(e,t){var n=this
...
return t||(t=e._promiseCallbacks={}),t}Object.defineProperty(e,"__esModule",{value:!0}),e.asap=Z,e.all=j,e.allSettled=I,e.race=D,e.hash=B,e.hashSettled=z,e.rethrow=V,e.defer=q,e.denodeify=x,e.configure=a,e.on=ge,e.off=ye,e.resolve=Y,e.reject=G,e.map=W,e.filter=X,e.async=e.EventTarget=e.Promise=e.cast=e.default=void 0
...
function I(e,t){return Array.isArray(e)?new L(A,e,t).promise:A.reject(new TypeError("Promise.allSettled must be called with an array"),t)}function D(e,t){return A.race(e,t)}L.prototype._setResultAt=T
...
for(var _e in a("instrument",!0),be)be.hasOwnProperty(_e)&&ge(_e,be[_e])}var we={asap:Z,cast:me,Promise:A,EventTarget:i,all:j,allSettled:I,race:D,hash:B,hashSettled:z,rethrow:V,defer:q,denodeify:x,configure:a,on:ge,off:ye,resolve:Y,reject:G,map:W,async:ve,filter:X}
e.default=we})),t("ember")}(),define("@ember/render-modifiers/modifiers/did-insert",["exports"],(function(e){"use strict"
...
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
var n=Ember.Component.extend({_infiniteScroller:Ember.inject.service("-infinite-scroller"),layout:t.default,tagName:"",onLoadMore:null,selector:null,useDocument:!1,scrollDebounce:100,leeway:"0%",error:null,isLoading:!1,isScrollable:!1,domElement:null,actions:{handleInsertElement:function(e){this._registerElement(e),this._checkScrollable(),this._listen()},handleDestroyElement:function(){this._stopListening(),this._deregisterElement()},loadMore:function(){this._loadMore()}},_registerElement:function(e){Ember.set(this,"domElement",e)},_deregisterElement:function(){Ember.set(this,"domElement",null)},_isScrollable:function(){return this._element().scrollHeight>this._element().clientHeight},_checkScrollable:function(){Ember.set(this,"isScrollable",this._isScrollable())},_listen:function(){this._scrollHandler=Ember.run.bind(this,"_scroll"),this._listener().addEventListener("scroll",this._scrollHandler)},_stopListening:function(){this._listener().removeEventListener("scroll",this._scrollHandler),Ember.run.cancel(this._scrollDebounceId)},_scroll:function(e){this._scrollDebounceId=Ember.run.debounce(this,"_debouncedScroll",e,this.scrollDebounce)},_debouncedScroll:function(){this._shouldLoadMore()&&this._loadMore()},_leeway:function(){return parseInt(this.leeway,10)},_listener:function(){return this.useDocument?Ember.get(this,"_infiniteScroller").document:this._element()},_element:function(){return this.selector?this.domElement.querySelector(this.selector):this.domElement},_shouldLoadMore:function(){var e
return(e=this.useDocument?this._detectBottomOfElementInDocument():this._detectBottomOfElement()).shouldLoadMore=e.reachedBottom&&!this.isLoading,Ember.get(this,"_infiniteScroller").log(e),e.shouldLoadMore},_detectBottomOfElementInDocument:function(){var e=Ember.get(this,"_infiniteScroller").documentElement.clientHeight,t=this._element().getBoundingClientRect().bottom,n=this._leeway(),r=t-e,i=r/t*100
return{clientHeight:e,bottom:t,leeway:n,pixelsToBottom:r,percentageToBottom:i,reachedBottom:i<=n}},_detectBottomOfElement:function(){var e=this._element().scrollHeight,t=this._element().scrollTop,n=this._element().clientHeight,r=e-n,i=this._leeway(),o=r-t,a=o/r*100
return{scrollHeight:e,scrollTop:t,clientHeight:n,bottom:r,leeway:i,pixelsToBottom:o,percentageToBottom:a,reachedBottom:a<=i}},_loadMore:function(){Ember.set(this,"error",null),Ember.set(this,"isLoading",!0),Ember.RSVP.resolve(this.onLoadMore()).catch(Ember.run.bind(this,"_loadError")).finally(Ember.run.bind(this,"_loadFinished"))},_loadError:function(e){this.isDestroyed||Ember.set(this,"error",e)},_loadFinished:function(){this.isDestroyed||Ember.set(this,"isLoading",!1)}})
e.default=n})),define("@zestia/ember-simple-infinite-scroller/services/-infinite-scroller",["exports"],(function(e){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
...
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
var t=Ember.HTMLBars.template({id:"htNZSKmX",block:'{"symbols":["&attrs","&default"],"statements":[[7,"div",false],[12,"class",[28,"concat",["infinite-scroller",[28,"if",[[23,0,["isLoading"]]," infinite-scroller--loading"],null],[28,"if",[[23,0,["isScrollable"]]," infinite-scroller--scrollable"],null]],null]],[13,1],[3,"did-insert",[[28,"action",[[23,0,[]],"handleInsertElement"],null]]],[3,"will-destroy",[[28,"action",[[23,0,[]],"handleDestroyElement"],null]]],[8],[0,"\\n  "],[14,2,[[28,"hash",null,[["error","isScrollable","isLoading","loadMore"],[[23,0,["error"]],[23,0,["isScrollable"]],[23,0,["isLoading"]],[28,"action",[[23,0,[]],"loadMore"],null]]]]]],[0,"\\n"],[9]],"hasEval":false}',meta:{moduleName:"@zestia/ember-simple-infinite-scroller/templates/components/infinite-scroller.hbs"}})
