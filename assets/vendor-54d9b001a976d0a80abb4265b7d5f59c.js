...
e.default=(f=class extends t.default{constructor(...e){super(...e),m(this,"isLoading",d,this),m(this,"scrollState",h,this),m(this,"lastScrollState",p,this),v(this,"debug",!0),v(this,"scroller",void 0),v(this,"debounceId",void 0),v(this,"setScroller",(0,a.modifier)(((e,[t])=>(this._registerScroller(t??e),()=>this._deregisterScroller())),{eager:!1})),v(this,"api",new Proxy(this,{get:(e,t)=>e._api[t],set(){}}))}get debounce(){return this.args.debounce??100}get shouldLoadMore(){return!this.isLoading&&(!!((0,o.isPresent)(this.args.percentDown)&&this.scrollState.direction===y&&this.scrollState.percentScrolled>=this.args.percentDown)||!!((0,o.isPresent)(this.args.percentUp)&&"UP"===this.scrollState.direction&&this.scrollState.percentScrolled<=this.args.percentUp))}get normalisedScrollerElement(){return this.scroller instanceof Document?this.scroller.documentElement:this.scroller}handleScroll(){this.debounceId=(0,n.debounce)(this,"_checkShouldLoadMore",this.debounce)}loadMore(e){this.isLoading=!0,(0,r.resolve)(this.args.onLoadMore?.(e)).finally((()=>{this.isLoading=!1,this._checkScrollable()}))}_registerScroller(e){this.scroller=e,this._startListening(),this._checkScrollable()}_deregisterScroller(){this._stopListening(),(0,n.cancel)(this.debounceId),this.scroller=null}_startListening(){this.scroller.addEventListener("scroll",this.handleScroll)}_stopListening(){this.scroller.removeEventListener("scroll",this.handleScroll)}_checkShouldLoadMore(){this.lastScrollState=this.scrollState,this.scrollState=this._getScrollState(),this._debug(),this.shouldLoadMore&&this.loadMore(this.scrollState.direction)}_checkScrollable(){this.isDestroying||this.isDestroyed||(this.scrollState=this._getScrollState())}_debug(){if(!this.debug)return
